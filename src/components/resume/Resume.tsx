...
export default function Resume() {
  ...
  return (
    <div className="resume">
      <p>
        I'm a Full-Stack Engineer at XPO, where I build dynamic web applications
        using Angular and TypeScript and robust and reliable backend systems
        using Java. I have a Bachelor of Technology degree in Computer Science
        from Dhirubhai Ambani Institute of Information and Communication
        Technology (DAIICT), one of the top engineering colleges in India.
      </p>
